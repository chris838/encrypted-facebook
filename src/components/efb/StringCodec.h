#ifndef EFB_STRINGCODEC_H
#define EFB_STRINGCODEC_H

/**
    This file contains the interface definition for the UTF8 decoder and encoder along with any classes which implement that interface.
*/
